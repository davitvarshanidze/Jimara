...
def fix_physx():
	def fix_file(file_path, substitutions):
	...
	fix_file(
        "Jimara-ThirdParty/NVIDIA/PhysX/PhysX/physx/source/compiler/cmake/linux/CMakeLists.txt",
        [
            ...
            [31, "SET(GCC_WARNINGS \"-Wall -Werror -Wno-invalid-offsetof -Wno-uninitialized -Wno-suggest-override -Wno-suggest-destructor-override -Wno-dtor-name\")"]
        ]
    )

	fix_file(
		"Jimara-ThirdParty/NVIDIA/PhysX/PhysX/physx/source/compiler/cmake/mac/CMakeLists.txt",
		[
			[27, 'SET(OSX_BITNESS "-arch arm64")'],
